...
Next, to double-check, [open the team storage account in Azure Portal](https://portal.azure.com/#@hackyourfuture.nl/resource/subscriptions/1120c89d-2a5f-4a15-a582-2ea34f0bb5c3/resourceGroups/rg-hyf-fp-team-c/providers/Microsoft.Storage/storageAccounts/sthyffpteamc/containersList).
...
[See fct_postings in team_c.dev_<yourname> (Databricks Catalog Explorer)](https://adb-7405619530719547.7.azuredatabricks.net/explore/data/team_c/dev_<yourname>/fct_postings?o=7405619530719547) in databricks.
...
select * 
from team_c.dev_<yourname>.fct_postings
```
...
> This should produce the url of the [ACA container](https://portal.azure.com/#@hackyourfuture.nl/resource/subscriptions/1120c89d-2a5f-4a15-a582-2ea34f0bb5c3/resourceGroups/rg-hyf-fp-team-c/providers/Microsoft.App/jobs/job-fp-ingest-dev/executionHistory) and you can view the execution history and logs of the ingestion job. You can also view the logs of the ingestion job in the portal.
...
LANDING_PATH=/Volumes/team_c/landing/dev/aca-dev/postings
```
...
| Airflow                  | your local Astro, `astro dev ps` URL      | `https://vm-hyf-team-c.westeurope.cloudapp.azure.com` |
...
There is also one shared admin login per team, `fp-airflow-admin-team-c` for
...
- `LANDING_CONTAINER=prod` — the **prod ADLS container** on `sthyffpteamc`,
