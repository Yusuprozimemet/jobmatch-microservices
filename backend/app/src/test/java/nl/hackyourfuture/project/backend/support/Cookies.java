 ...
 *
 * <p>The name is a mechanism, not a contract. Today it is Spring Security's {@code JSESSIONID};
 * from Day 13 it is a JWT cookie under a different name. What the contract tests actually pin is
 ...
 * takes the name from here, so Day 13 edits the line below and no assertion in {@code contract/}
 * changes.
 */
public final class Cookies {

    /** The cookie the application authenticates with. */
    public static final String AUTH = "JSESSIONID";
